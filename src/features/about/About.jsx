      ...
      <div className="max-w-7xl mx-auto p-6 md:p-10 bg-white shadow-xl rounded-lg flex flex-col md:flex-row items-center gap-12">
        ...
        >
          ...
          <p className="text-lg text-black leading-relaxed mb-6">
            فخامة باب للابواب والنوافذ هي وكالة أعمال سعودية المنشأ متخصصة في
          ...
          <p className="text-lg text-black leading-relaxed mb-6">
            نعمل على توفير مستقبل صناعة الأبواب والنوافذ بالمملكة. لدى شركة
            فخامة باب للنوافذ تقدم كل ما هو مبتكر ومتطور عالميًا في مجال الأبواب
